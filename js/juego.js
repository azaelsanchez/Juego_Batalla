let juego = {
    ...
    resetPlayer: function(p1clase) {
        switch (p1clase) {
            case "mago":
                player1 = new Player (p1clase, 125,250, 175, 105, 75);
                break;
            case "guerrero":
                player1 = new Player(p1clase, 190,0, 250, 100, 55);
                break;
            case "monje":
                player1 = new Player(p1clase, 170,125, 190, 135, 100);
            break;
            case "ninja":
                player1 = new Player(p1clase, 140,75, 140, 190, 150);
                break;
        }
    ...
    setFight: function() {
        ...
        let player21 = new Player("Mago", 125,250, 175, 105, 75);
        let player22 = new Player("Guerrero", 190,0, 250, 100, 55);
        let player23 = new Player("Monje", 170,125, 190, 135, 100);
        let player24 = new Player("Ninja", 140,75, 140, 190, 150);
        ...
        getMovimientos.innerHTML = '<br><a href="#" class="btn-prefight" onclick="juego.hit()">Ataca</a>';
